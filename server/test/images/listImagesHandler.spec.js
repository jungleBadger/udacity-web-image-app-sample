...
describe('GET /images', () => {
    it('should return a list of images', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const response = yield (0, supertest_1.default)(app_1.default).get('/images');
        expect(response.status).toBe(200);
        expect(response.body).toEqual(expectedResponse);
        expect(fs_1.promises.readdir).toHaveBeenCalled();
    }));
    it('should handle errors when failing to list images', () => __awaiter(void 0, void 0, void 0, function* () {
        // Mocking readdir to reject with an error
        fs_1.promises.readdir.mockRejectedValue(new Error('Failed to read directory'));
        const response = yield (0, supertest_1.default)(app_1.default).get('/images');
