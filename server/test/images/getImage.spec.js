...
describe('getRawImage', () => {
  ...
  it('returns a stream when the file exists', () => {
    ...
    expect(fs_1.default.createReadStream).toHaveBeenCalledWith(
      path_1.default.join(__dirname, '../../../assets/images', 'existent.jpg'),
    );
...
describe('getProcessedImage', () => {
  it('should throw an error if filename is not provided', () => {
    expect(() => getImage.getProcessedImage('')).toThrow(
