...
describe('POST /upload', () => {
  ...
  it('should handle empty submissions', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const res = yield (0, supertest_1.default)(app_1.default).post(
        '/images/upload',
      );
      expect(res.status).toBe(400);
      expect(res.text).toBe('Only .jpg files are allowed!');
    }));
  it('should accept only jpg files', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const res = yield (0, supertest_1.default)(app_1.default)
        .post('/images/upload')
        .attach(
          'image',
          path_1.default.join(__dirname, 'samples/testScript.js'),
        );
      expect(res.status).toBe(400);
      expect(res.text).toBe('Only .jpg files are allowed!');
      const resSecond = yield (0, supertest_1.default)(app_1.default)
        ...
        .attach(
          'image',
          path_1.default.join(__dirname, 'samples/testText.txt'),
        );
