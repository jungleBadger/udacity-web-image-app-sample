...
// listImages.spec.ts
const listImages_1 = __importDefault(require("../../src/helpers/images/listImages"));
...
describe('listImages', () => {
    ...
    //
    it('should list all JPG images in the directory', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should throw an error if reading directory fails', () => __awaiter(void 0, void 0, void 0, function* () {
