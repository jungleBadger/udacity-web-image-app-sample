...
describe('resizeImage', () => {
  ...
  it('should throw an error if a parameter is missing', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      yield expect(
        (0, resizeImage_1.resizeImage)('', mockWidth, mockHeight),
  ...
  it('should throw an error if the file does not exist', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      yield expect(
        (0, resizeImage_1.resizeImage)(mockImagePath, mockWidth, mockHeight),
      ).rejects.toThrow('File does not exist');
    }));
  it('should resize the image if all parameters are valid and file exists', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      // Set up the mocks
      ...
      // Call the function
      const resizedImage = yield (0, resizeImage_1.resizeImage)(
        mockImagePath,
        mockWidth,
        mockHeight,
      );
      // Assert the results
      expect(fs_1.default.existsSync).toHaveBeenCalledWith(
        expect.stringContaining(mockImagePath),
      );
      expect(sharp_1.default).toHaveBeenCalledWith(
        expect.stringContaining(mockImagePath),
      );
      expect(resizedImage).toHaveProperty(
        'filePath',
        expect.stringContaining(`${mockImagePath}-${mockWidth}x${mockHeight}`),
      );
    }));
